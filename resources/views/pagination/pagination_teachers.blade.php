    ...
    <tbody class="list form-check-all">
        @foreach ($teacher as $teachers)
            <tr>
                ...
                <td>
                    <button class="btn btn-success btn-sm mx-2 edit-item-btn" data-bs-toggle="modal"
                ...
                <div id="editModals-{{ $teachers->id }}" class="modal fade" tabindex="-1" aria-hidden="true"
                    style="display: none;">
                            ...
                            <div class="modal-body">
                                <form action='{{ url('teacher/' . $teachers->id . '/edit') }}' method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nip" class="form-control"
                                                    autocomplete="off" value="{{ $teachers->nip }}"
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    value="{{ $teachers->name }}" placeholder="Masukkan nama guru">
                                                @error('name')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="email"
                                                        ...
                                                        class="form-control" placeholder="Masukkan email guru"
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="name" class="form-label">Jenis
                                                    kelamin</label>
                                                <select class="form-control" name="gender" data-choices
                                                    data-choices-search-false data-choices-removeItem>
                                                    <option {{ $teachers->gender == '' ? 'selected' : '' }}>
                                                        Silahkan
                                                        pilih jenis
                                                        kelamin
                                                    </option>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label for="name" class="form-label">No
                                                    Handphone</label>
                                                <input type="text" name="phone" class="form-control"
                                                    value="{{ $teachers->phone }}" placeholder="Masukkan no hp guru">
                                                @error('phone')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="password" id="password-input-{{ $teachers->id }}"
                                                    name="password" class="form-control pe-5 password-input"
                                                    onpaste="return false" placeholder="Masukkan password guru"
                                            ...
                                            <div id="password-contain-{{ $teachers->id }}"
                                                ...
                                                <p id="pass-length-{{ $teachers->id }}" class="invalid fs-12 mb-2">
                                                    Minimal <b>8
                                                        Karakter</b>
                                                </p>
                                                <p id="pass-lower-{{ $teachers->id }}" class="invalid fs-12 mb-2">
                                                    Terdapat
                                                    <b>huruf
                                                        kecil</b>
                                                    (a-z)
                                                </p>
                                                <p id="pass-upper-{{ $teachers->id }}" class="invalid fs-12 mb-2 ">
                                                    Terdapat
                                                    Huruf
                                                    <b>Besar</b>
                                                    (A-Z)
                                                ...
                                                <p id="pass-number-{{ $teachers->id }}" class="invalid fs-12 mb-0 ">
                                                    Terdapat
                                                    <b>angka</b>
                                                    (0-9)
                                                </p>
                ...
                <!-- Modal -->
                <div class="modal fade zoomIn" id="deleteRecordModal-{{ $teachers->id }}" tabindex="-1"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                    ...
                                    <form method="POST" action="{{ route('teacher.hapus', $teachers->id) }}"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
