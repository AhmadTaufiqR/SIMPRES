                ...
                <div class="col-lg-12">
                    <div class="card" id="invoiceList">
                        <div class="card-header border-0">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title mb-0 flex-grow-1">Absensi/Form </h5>
                                    ...
                                    <table class="table align-middle table-nowrap">
                                        <thead class="text-muted">
                                            <tr>
                                                ...
                                                <th class="sort text-uppercase" data-sort="username">Jadwal Pelajaran</th>
                                                <th class="sort text-uppercase" data-sort="username">Waktu Masuk</th>
                                                <th class="sort text-uppercase" data-sort="username">Waktu Keluar</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <td> 
                                                        <input type="time" class="form-control" name="start_attendance" id="start_attendance" value="{{ old('start_attendance') }}" disabled>
                                                    </td>
                                                    <td> 
                                                        <input type="time" class="form-control" name="end_attendance" id="end_attendance" value="{{ old('end_attendance')}}" disabled>
                                                    </td>
                                                    <td> 
                                                        <button type="submit" class="btn btn-success" data-bs-toggle="modal"
                                                        data-bs-target="#addModals-{{$schedule->id}}">Tambah</button>
                                                    </td>
                                            </tr>
                                            <div id="addModals-{{$schedule->id}}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div
                                                        ...
                                                        <div class="modal-header p-3">
                                                            ...
                                                            @if (session('status'))
                                                                <div class="alert alert-succes">
                                                                    {{ session('status') }}</div>
                                                            @endif
                                                            <h4 class="card-title mb-0">Tambah Absensi</h4>
                                                            <button type="button"
                                                                class="btn-close"
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ url('presences/add-presence-data/'. $schedule->id) }} "method="POST">
                                                                @method('POST')
                                                                @csrf
                                                                <div class="mb-3">
                                                                    <label for="name"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="jadwal"
                                                                        class="form-label">Jadwal Pelajaran</label>
                                                                    <input type="text"
                                                                        name="jadwal"
                                                                        class="form-control"
                                                                ...
                                                                <div class="mb-3">
                                                                    <label
                                                                        for="start_attendance"
                                                                        class="form-label">Jam Masuk</label>
                                                                        <input type="datetime-local" class="form-control" name="start_attendance" id="start_attendance">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label
                                                                        for="end_attendance"
                                                                        class="form-label">Jam Keluar</label>
                                                                        <input type="datetime-local" class="form-control" name="end_attendance" id="end_attendance">
