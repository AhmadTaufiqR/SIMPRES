                                ...
                                <ul class="navbar-nav" id="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="/courses">
                                            <i class="las la-graduation-cap"></i> <span data-key="t-headmasters">Course</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="card" id="invoiceList">
                        <div class="card-header border-0">
                            <div class="d-flex align-items-center">
                                <h5 class="card-title mb-0 flex-grow-1 text-decoration-underline">Jadwal Pelajaran</h5>
                                <div class="flex-shrink-0">
                                    <div class="d-flex gap-2 flex-wrap">
                                        ...
                                        class="ri-add-line align-bottom me-1"></i> Tambah Pelajaran</button>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="card border card-border-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                data-bs-target="#deleteRecordModal-{{ $courses->id }}"><i class="ri-delete-bin-5-line"></i></button>
                            </div>
                            <div class="card-body">
                                <div class="text-center">
                                    <a  class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editModals{{ $courses->id }}">Edit</a>
                                ...
                                <div id="editModals{{ $courses->id }}" class="modal fade" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 overflow-hidden">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('courses/' . $courses->id . '/edit') }}" method="POST">
                                                    @csrf
                                                    <div class="mb-3">
                                ...
                                id="deleteRecordModal-{{ $courses->id }}"
