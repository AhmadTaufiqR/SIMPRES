                                        ...
                                        <div>
                                            <table class="table align-middle table-nowrap">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        {{-- <form action="/presence-create" method="POST"> --}}
                                                            @csrf
                                                            <td>{{$loop->iteration}}</td>
                                                            {{-- <td>{{$presence->schedule->id}}</td> --}}
                                                            <td>{{$presence->schedule->teacher->name}}</td>
                                                            <td>{{$presence->schedule->teacher->nip}}</td>
                                                            <td>{{$presence->schedule->course->name}}</td>
                                                            <td> 
                                                                <input type="time" class="form-control" name="start_attendance" id="start_attendance" value="{{ date('H:i', strtotime($presence->start_attendance)) }}">
                                                            </td>
                                                            <td> 
                                                                <input type="time" class="form-control" name="end_attendance" id="end_attendance" value="{{ date('H:i', strtotime($presence->end_attendance)) }}">
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
