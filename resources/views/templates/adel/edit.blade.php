...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="assets/js/layout.js.css" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="assets/js/layout.js.css" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="assets/js/layout.js.css" rel="stylesheet" type="text/css" />
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="#sidebarSignIn" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> Profile
                                        </a>
                                </ul>
                            </div>
                        </li>
                            ...
                            <div class="card mt-n5">
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <h5 class="fs-16 mb-1">Suparman</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="nipInput" placeholder="Enter your nip" value="246745">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="lastnameInput" placeholder="Enter your lastname" value="Suparman">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="phonenumberInput" class="form-label">Username</label>
                                                            <input type="text" class="form-control" id="usernamerInput" placeholder="Enter your username" value="Suparman">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="passwordInput" placeholder="Enter your password" value="Suparman123">
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="phonenumberInput" placeholder="Enter your phone number" value="085962794973">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="phonenumberInput" class="form-label">Address</label>
                                                            <input type="text" class="form-control" id="addresinput" placeholder="Enter your address" value="085962794973">
                                                        </div>
                                                    </div>
                                                    
                                                    <!--end col-->
                                                    <div class="col-lg-6">
                                                            <label for="designationInput" class="form-label">About</label>
                                                        </div>
                                                        <div class="mb-3"> 
                                                    </div>
                                                    <!--end col-->
