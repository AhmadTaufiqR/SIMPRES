                            ...
                            <div class="container-fluid">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link menu-link" href="/generation">
                                        <i class="las la-graduation-cap"></i> <span data-key="t-headmasters">Generation</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 overflow-hidden">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/generation-create-data" method="POST">
                                                            @csrf
                                                            <div class="mb-3">
                                                                <label for="tahun_awal" class="form-label">Tahun Akademik</label>
                                                                <div class="d-flex align-items-center">
                                                                    <input type="number" name="tahun_awal"
                                                                    class="form-control me-1" 
                                                                    id="tahun_awal" 
                                                                    value="{{ old('acamedic_years') }}" placeholder="Tahun Awal">
                                                                    @error('tahun_awal')
                                                                    ...
                                                                    class="form-control me-1" 
                                                                    id="tahun_akhir"
                                                                    value="{{ old('acamedic_years') }}" placeholder="Tahun Akhir">
                                                                    @error('tahun_akhir')
                                                                    <span class="text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                ...
                                <div class="table-responsive table-card">
                                    ...
                                    <table class="table align-middle table-nowrap">
                                        <thead class="text-muted">
                                            <tr>
                                                <th scope="col">ID</th>
                                                <th class="sort text-uppercase" data-sort="angkatan">Angkatan</th>
                                                <th class="sort text-uppercase" data-sort="semester">Semester</th>
                                        ...
                                        <tbody class="list form-check-all" id="invoice-list-data">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-success edit-item-btn" data-bs-toggle="modal" data-bs-target="#editModals-{{ $generation->id }}">Edit</button>
                                                    <button class="btn btn-danger btn-sm remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal-{{ $generation->id }}">Delete</button>
                                                </td>
                                            </tr>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ url('generation/' . $generation->id . '/edit') }}" method="POST">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="tahun_awal" class="form-label">Tahun Akademik</label>
                                                                    <div class="d-flex align-items-center">
                                                                        <input type="number" name="tahun_awal" class="form-control me-1" id="tahun_awal" value="{{ explode('/', $generation->academic_years)[0] }}" placeholder="Tahun Awal">
                                                                        @error('tahun_awal')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                        @enderror
                                                                        <span>/</span>
                                                                        <input type="number" name="tahun_akhir" class="form-control me-1" id="tahun_akhir" value="{{ explode('/', $generation->academic_years)[1] }}" placeholder="Tahun Akhir">
                                                                        @error('tahun_akhir')
                                                                        <span class="text-danger">{{ $message }}</span>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="semester" class="form-label">Semester</label>
                                                                    <select class="form-select" id="semester" name="semester">
                                                                        <option value="Ganjil" {{ $generation->semester == 'Ganjil' ? 'selected' : '' }}>Ganjil</option>
                                                                        <option value="Genap" {{ $generation->semester == 'Genap' ? 'selected' : '' }}>Genap</option>
                                                                    </select>
                                                                </div>
                                                                <div class="text-end">
                                                                    <button type="submit" name="submit" class="btn btn-primary">Simpan</button>
                                            ...
                                            <script>
                                                // Function to populate edit modal with generation data
                                                function populateEditModal(generation) {
                                                    // Set value for tahun_awal and tahun_akhir inputs
                                                    document.getElementById('tahun_awal_' + generation.id).value = generation.academic_years.split('/')[0];
                                                    document.getElementById('tahun_akhir_' + generation.id).value = generation.academic_years.split('/')[1];
                                                    
                                                    // Set value for semester select
                                                    document.getElementById('semester_' + generation.id).value = generation.semester;
                                                }
                                            
                                                // Event listener to trigger modal population
                                                document.addEventListener('DOMContentLoaded', function() {
                                                    var editButtons = document.querySelectorAll('.edit-item-btn');
                                                    editButtons.forEach(function(button) {
                                                        button.addEventListener('click', function() {
                                                            var generationId = this.dataset.generationId;
                                                            var generationData = JSON.parse(this.dataset.generationData);
                                            
                                                            populateEditModal(generationData);
                                                        });
                                                    });
                                                });
                                            </script>
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade zoomIn" id="deleteRecordModal-{{ $generation->id }}" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                            ...
                                                            <form method="POST" action="{{ route('generation.hapus', $generation->id) }}" class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
