...
<head>
    ...
    <meta charset="utf-8" />
    <title>Tahun Akademik | SCOde</title>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link active" href="/generation">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <input type="number" name="tahun_awal"
                                                                            class="form-control me-1" id="tahun_awal"
                                                                            value="{{ old('acamedic_years') }}"
                                                                        ...
                                                                        <input type="number" name="tahun_akhir"
                                                                            class="form-control me-1" id="tahun_akhir"
                                                                            value="{{ old('acamedic_years') }}"
