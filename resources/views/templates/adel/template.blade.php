                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-9">
                            <div class="card mt-xxl-n5">
                                @if (session('status'))
                                <div class="alert alert-succes">{{ session('sttaus')}}</div>
                                ...
                                <div class="card-body p-4">
                                    <form action="headmaster/create" method="POST">
                                        @csrf 
                                        ...
                                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label>Nip</label>
                                                            <input type="text" class="form-control" name="nip" placeholder="Enter your firstname" value="{{ $headmaster->nip }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label>Name</label>
                                                            <input type="text" class="form-control" name="name" placeholder="Enter your lastname" value="{{ $headmaster->name }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="username" placeholder="Enter your lastname" value="{{ $headmaster->username }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="password" placeholder="Enter your lastname" value="{{ $headmaster->username }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label>Phone</label>
                                                            <input type="text" class="form-control" name="phone" placeholder="Enter your phone number" value="{{ $headmaster->phone }}">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label>Address</label>
                                                            <input type="text" class="form-control" name="address" placeholder="Enter your email" value="{{ $headmaster->address }}">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            ...
                                                            <a href="/headmaster" type="button" class="btn btn-soft-success">Cancel</a>
                                                        </div>
                                                    </div>
                                                    <!--end col-->
                                                </div>
