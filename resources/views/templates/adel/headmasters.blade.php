                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Suparman</span>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                                <i class="ri-account-circle-line"></i> <span data-key="t-headmasters">Headmasters</span>
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4 profile-wrapper">
                        <div class="row g-4">
                            ...
                            <div class="col">
                                <div class="p-2">
                                    <h3 class="text-white mb-1">Suparman</h3>
                                ...
                                <div class="d-flex profile-wrapper">
                                    ...
                                    @if (isset($headmaster) && $headmaster->name != '')
                                        <div class="flex-shrink-0">
                                            <a href="/create" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i>Edit Profile</a>
                                        </div>
                                    @else
                                        <div class="flex-shrink-0">
                                            <a href="/create" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i>Tambah Profile</a>
                                        </div>
                                    @endif
                                </div>
                                <!-- Tab panes -->
                                                            ...
                                                            <table class="table table-borderless mb-0">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-muted">{{ $headmaster->nip }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Name :</th>
                                                                        <td class="text-muted">{{ $headmaster->name }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Username :</th>
                                                                        <td class="text-muted">{{ $headmaster->username }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Password :</th>
                                                                        <td class="text-muted">{{ $headmaster->password }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Phone</th>
                                                                        <td class="text-muted">{{ $headmaster->phone }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th class="ps-0" scope="row">Address</th>
                                                                        <td class="text-muted">{{ $headmaster->address }}</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <p>SMP Negeri 1 Maesan
                                                            Jl. Sukowono, Krajan 2, Sumbersari, Maesan, Kabupaten Bondowoso, Jawa Timur 68262, Indonesia 
                                                            Kabupaten Jember, Jawa Timur, 68262</p>
                                                        <p>
                                                            Berapakah nomor telepon untuk SMP Negeri 1 Maesan?
                                                            Nomor telepon untuk SMP Negeri 1 Maesan adalah (0332) 426490.
                                                            Q2
                                                            Di manakah lokasi SMP Negeri 1 Maesan?
                                                            SMP Negeri 1 Maesan berlokasi di Jl. Sukowono, Krajan 2, Sumbersari, Maesan, Kabupaten Bondowoso, Jawa Timur 68262, Indonesia, Kabupaten Jember.
                                                            Q3
                                                            Apakah ada kontak utama untuk SMP Negeri 1 Maesan?
                                                            Anda bisa menghubungi SMP Negeri 1 Maesan lewat telepon menggunakan nomor (0332) 426490.</p>
                                                        <div class="row">
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="{{ asset("https://1.envato.market/velzon-admin") }}" target="_blank" class="btn btn-primary w-100">Buy Now</a>
                </div>
            </div>
        </div>
    </div>
