                        ...
                        <div id="scrollbar">
                            <div class="container-fluid">
                                ...
                                <ul class="navbar-nav" id="navbar-nav">
                                    <!-- end Dashboard Menu -->
                                    <li class="nav-item">
                                        <a class="nav-link menu-link" href="/rooms">
                                            <i class="las la-graduation-cap"></i> <span data-key="t-headmasters">DAFTAR KELAS</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="card border card-border-primary">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="card-title mb-0"><span class="badge bg-warning align-middle fs-20">{{ $rooms->name_class }}</span></h6>
                                <button type="button" class="btn btn-outline-danger btn-icon waves-effect waves-light" data-bs-toggle="modal"
                                data-bs-target="#deleteRecordModal-{{ $rooms->id }}"><i class="ri-delete-bin-5-line"></i></button>
                            </div>
                            <div class="card-body">
                                <div class="text-center">
                                    <a  class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editModals{{ $rooms->id }}">Edit</a>
                                    {{-- <button type="button" class="btn btn-outline-success mb-2 btn-block" data-bs-toggle="modal" data-bs-target="#editModals{{ $rooms->id }}">Edit</button> --}}
                                </div>
                                <div id="editModals{{ $rooms->id }}" class="modal fade" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content border-0 overflow-hidden">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ url('room/' . $rooms->id . '/edit') }}" method="POST">
                                                    @csrf
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="name" name="name_class"
                                                        class="form-control"
                                                        value="{{ $rooms->name_class }}" id="name"
                                                        placeholder="Masukkan Nama Kelas">
                                                        @error('name')
                                                        <span
                                                        class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="mt-2 text-center">
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        Apakah kamu yakin menghapus data ini?</p>
                                                </div>
                                            </div>
                                            <div
