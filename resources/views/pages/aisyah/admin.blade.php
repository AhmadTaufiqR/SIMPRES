                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <div class="d-flex gap-2 flex-wrap">
                                                ...
                                                <button href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#signupModals"><i class="ri-add-line align-bottom me-1"></i> Tambah Admin</button>
                                                ...
                                                <div class="modal-body">
                                                    <form action="/admin-create-data" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="username" class="form-control"  value="{{ old('username') }}" id="username" placeholder="Enter your username">
                                                            @error('username') <span class="text-danger">{{ $message}}</span>@enderror
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="name" class="form-label">Name </label>
                                                            <input type="name" name="name" class="form-control" value="{{ old('name') }}" id="name" placeholder="Enter your name">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            @error('passowrd') <span class="text-danger">{{ $message}}</span>@enderror
                                                        </div>
                                                        <div class="text-end">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-xxl-5 col-sm-12">
                                                <div class="search-box">
                                                    <input type="text" class="form-control search bg-light border-light" placeholder="Cari nama..">
            ...
            <table class="table align-middle table-nowrap">
                <thead class="text-muted">
                    <tr>
                        ...
                        <th class="sort text-uppercase" data-sort="username">Username</th>
                ...
                <tbody class="list form-check-all" id="invoice-list-data">
                    @foreach ($admin as $admins)
                        <tr>
                            ...
                            <td>
                            <form method="POST" action="{{ route('admin.hapus', $admins->id) }}" class="d-inline">
                            @csrf
                                @method("DELETE")
                                <button class="btn btn-danger btn-sm">Hapus</button>
                            </form>
                            <button class="btn btn-success mx-2" data-bs-toggle="modal" data-bs-target="#editModals-{{ $admins->id }}">Edit</button>
                                 
                            </td>
                            <div id="editModals-{{ $admins->id}}" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
                                         <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content border-0 overflow-hidden">
                                                <div class="modal-header p-3">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{url('admin/'.$admins->id.'/edit') }} "method="POST">                                    
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="username" class="form-label">Username</label>
                                                            <input type="text" name="username" class="form-control"  value="{{ $admins->username}}" id="username" placeholder="Enter your username">
                                                            @error('username') <span class="text-danger">{{ $message}}</span>@enderror
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="name" class="form-label">Name </label>
                                                            <input type="name" name="name" class="form-control" value="{{$admins->name }}" id="name" placeholder="Enter your name">
                                                            @error('name') <span class="text-danger">{{ $message}}</span>@enderror
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="exampleInputPassword1" class="form-label">Password</label>
                                                            <input type="password" name="password" class="form-control" value="{{$admins->name }}" id="exampleInputPassword1" placeholder="Enter your password">
                                                            @error('passowrd') <span class="text-danger">{{ $message}}</span>@enderror
                                                        </div>
                                                        <div class="text-end">
