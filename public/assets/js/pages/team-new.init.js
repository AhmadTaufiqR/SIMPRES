...
function onButtonGroupClick(e) {
    "list-view-button" === e.target.id ||
    "list-view-button" === e.target.parentElement.id
            ...
            var r = e.bookmark ? "active" : "",
                m = e.memberImg
                    ...
                    : '<div class="avatar-title border bg-light text-primary rounded-circle text-uppercase">' +
                      ...
                      "</div>";
            (document.querySelector("#team-member-list").innerHTML +=
                '<div class="col">            <div class="card team-box">                <div class="team-cover">                    <img src="' +
                e.coverImg +
                '" alt="" class="img-fluid" />                </div>                <div class="card-body p-4">                    <div class="row align-items-center team-row">                        <div class="col team-settings">                            <div class="row">                                <div class="col">                                    <div class="flex-shrink-0 me-2">                                        <button type="button" class="btn btn-light btn-icon rounded-circle btn-sm favourite-btn ' +
                r +
                '">                                            <i class="ri-star-fill fs-14"></i>                                        </button>                                    </div>                                </div>                                <div class="col text-end dropdown">                                    <a href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">                                        <i class="ri-more-fill fs-17"></i>                                    </a>                                    <ul class="dropdown-menu dropdown-menu-end">                                        <li><a class="dropdown-item edit-list" href="#addmemberModal"  data-bs-toggle="modal" data-edit-id="' +
                e.id +
                ...
                e.id +
                '"><i class="ri-delete-bin-5-line me-2 align-bottom text-muted"></i>Remove</a></li>                                    </ul>                                </div>                            </div>                        </div>                        <div class="col-lg-4 col">                            <div class="team-profile-img">                                <div class="avatar-lg img-thumbnail rounded-circle flex-shrink-0">' +
                m +
                '</div>                                <div class="team-content">                                    <a class="member-name" data-bs-toggle="offcanvas" href="#member-overview" aria-controls="member-overview">                                        <h5 class="fs-16 mb-1">' +
                e.memberName +
                '</h5>                                    </a>                                    <p class="text-muted member-designation mb-0">' +
                e.position +
                '</p>                                </div>                            </div>                        </div>                        <div class="col-lg-4 col">                            <div class="row text-muted text-center">                                <div class="col-6 border-end border-end-dashed">                                    <h5 class="mb-1 projects-num">' +
                e.projects +
                '</h5>                                    <p class="text-muted mb-0">Projects</p>                                </div>                                <div class="col-6">                                    <h5 class="mb-1 tasks-num">' +
                e.tasks +
                '</h5>                                    <p class="text-muted mb-0">Tasks</p>                                </div>                            </div>                        </div>                        <div class="col-lg-2 col">                            <div class="text-end">                                <a href="pages-profile.html" class="btn btn-light view-btn">View Profile</a>                            </div>                        </div>                    </div>                </div>            </div>        </div>'),
                bookmarkBtn(),
                editMemberList(),
                removeItem(),
                memberDetailShow();
                    ...
                    return (
                        e.id == r &&
                            ...
                            (document.getElementById(
                                "createMemberLabel"
                            ).innerHTML = "Edit Member"),
                            (document.getElementById("addNewMember").innerHTML =
                                "Save"),
                            "" == e.memberImg
                            ...
                            (document.getElementById("cover-img").src =
                                e.coverImg),
                            (document.getElementById("memberid-input").value =
                                e.id),
            ...
            (r = t.getAttribute("data-remove-id")),
                document
                    ...
                    .addEventListener("click", function () {
                        ...
                        (t = r),
                            loadTeamData(
                                (allmemberlist = allmemberlist.filter(function (
                                    e
                                ) {
                                    return e.id != t;
                                }))
                            ...
                            document
                                .getElementById("close-removeMemberModal")
                                .click();
                    });
        });
    });
    ...
    Array.from(document.querySelectorAll(".team-box")).forEach(function (a) {
        a.querySelector(".member-name").addEventListener("click", function () {
            var e = a.querySelector(".member-name h5").innerHTML,
                ...
                r = a.querySelector(".member-img")
                    ? a.querySelector(".member-img").src
                    : "assets/images/users/user-dummy-img.jpg",
            ...
            (document.querySelector("#member-overview .profile-img").src = r),
                (document.querySelector(
                    "#member-overview .team-cover img"
                ).src = m),
                (document.querySelector(
                    "#member-overview .profile-name"
                ).innerHTML = e),
                (document.querySelector(
                    "#member-overview .profile-designation"
                ).innerHTML = t),
                (document.querySelector(
                    "#member-overview .profile-project"
                ).innerHTML = i),
                (document.querySelector(
                    "#member-overview .profile-task"
                ).innerHTML = n);
        });
    });
}
document
    ...
    Array.from(document.querySelectorAll(".addMembers-modal")).forEach(
        function (e) {
                        ...
                        ? (e.preventDefault(),
                          ...
                          "" === t || "" === r || editlist
                              ? "" !== t &&
                                ...
                                (allmemberlist = allmemberlist.map(function (
                                    e
                                ) {
                                    return e.id == o
                                        ? {
                          ...
                          document
                              .getElementById("createMemberBtn-close")
                              .click())
